<template>
	<li class="navigation-item" :class="{ selected: isSelected }">
		<router-link :to="way" class="navigation-item__link">
			<slot name="icon">
				<svg
					version="1.1"
			...
			<p class="navigation-item__description">{{ description }}</p>
		</router-link>
	</li>
</template>
